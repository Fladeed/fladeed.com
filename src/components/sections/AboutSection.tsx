      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          <GlassCard variant="light" className="inline-block mb-6">
            <span className="text-blue-300 font-medium text-sm">About Us</span>
          </GlassCard>
        ...
        {/* Values */}
        <div className="mb-16">
          <h3 className="text-3xl font-bold text-center text-white mb-8">Our Values</h3>
        ...
        {/* Team */}
        <div>
          <h3 className="text-3xl font-bold text-center text-white mb-8">Meet the Team</h3>
